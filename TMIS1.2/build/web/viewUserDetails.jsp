...
<nav>
  <ul>
    ...
    <input type="text"  name="idNumber" value="<c:out value="${row.idNumber}"/>" readonly>

    <label for="address">Address</label>
    <input type="text"  name="address" value="<c:out value="${row.address}"/>" readonly>

    <label for="contactNumber">Contact Number</label>
    <input type="text"  name="contactNumber" value="<c:out value="${row.contactNumber}"/>" readonly>

    <label for="email">Email Address</label>
    <input type="email"  name="email" value="<c:out value="${row.email}"/>" readonly>

    <label for="health">Health</label>
    <input type="text" name="health" value="<c:out value="${row.health}"/>" readonly>

    <label for="licenseType">License Type</label>
    <input type="text"  name="licenseType" value="<c:out value="${row.licenseType}"/>" readonly>

    <label for="employeeNumber">Employee Number</label>
    <input type="text"  name="employeeNumber" value="<c:out value="${row.employeeNumber}"/>" readonly>
    </c:forEach>
           </form>
