...
<nav>
 ...
 <center>
	...
	<form action="updateRouteDetailsProcess.jsp" name="updateRouteDetailsProcess">
    <label >ID</label>
    ...
    <label for="truckVinNumber">Truck VIN Number</label>
    <input type="text" id="truckVinNumber" name="truckVinNumber" value="<c:out value="${row.truckVinNumber}"/>">

    <label for="departureLocation">Departure Location</label>
    <input type="text" id="departureLocation" name="departureLocation" value="<c:out value="${row.departureLocation}"/>">

    <label for="destinationLocation">Destination Location</label>
    <input type="text" id="destinationLocation" name="destinationLocation" value="<c:out value="${row.destinationLocation}"/>">

    <label for="routeApprovedBy">Route Approved By</label>
    <input type="text" id="routeApprovedBy" name="routeApprovedBy" value="<c:out value="${row.routeApprovedBy}"/>">
