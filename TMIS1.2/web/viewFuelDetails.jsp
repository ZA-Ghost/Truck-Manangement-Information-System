...
<html>
    <head>
        ...
        <title>Admin: View Fuel Details</title>
...
<nav>
  <ul>
    ...
    <sql:param value="${param.id}" />
        ...
        <input type="text" id="employeeNumber" name="employeeNumber" value="<c:out value="${row.employeeNumber}"/>" readonly>

        <label for="driverName">Driver Name</label>
        <input type="text" id="driverName" name="driverName" value="<c:out value="${row.driverName}"/>" readonly>

        <label for="driverSurname">Driver Surname</label>
        <input type="text" id="driverSurname" name="driverSurname" value="<c:out value="${row.driverSurname}"/>" readonly>

        <label for="truckNumberPlate">Truck Number Plate</label>
        <input type="text" id="truckNumberPlate" name="truckNumberPlate" value="<c:out value="${row.truckNumberPlate}"/>" readonly>

        <label for="date">Date</label>
        <input type="date" id="date" name="date" value="<c:out value="${row.date}"/>" readonly>

        <label for="pricePerLitre">Price Per Litre</label>
        <input type="number" id="pricePerLitre" name="pricePerLitre" value="<c:out value="${row.pricePerLitre}"/>" readonly>

        <label for="litresPouredIn">Litres Poured In</label>
        <input type="number" id="litresPouredIn" name="litresPouredIn" value="<c:out value="${row.litresPouredIn}"/>" readonly>

        <label for="amountSpent">Amount Spent</label>
        <input type="number" id="amountSpent" name="amountSpent" value="<c:out value="${row.amountSpent}"/>" readonly>
