...
<nav>
  <ul>
   ...
   <form action="updateServiceDetailsProcess.jsp" name="updateServiceDetailsProcess">
   ...
   <label for="brand">Brand</label>
    <input type="text" id="brand" name="brand" value="<c:out value="${row.brand}"/>">

    <label for="model">Model</label>
    <input type="text" id="model" name="model" value="<c:out value="${row.model}"/>">
    ...
    <input type="text" id="vinNumber" name="vinNumber" value="<c:out value="${row.vinNumber}"/>">

    <label for="numberPlate">Number Plate</label>
    <input type="text" id="numberPlate" name="numberPlate" value="<c:out value="${row.numberPlate}"/>">

    <label for="licenseDisk">License Disk ED</label>
    <input type="date" id="licenseDisk" name="licenseDisk" value="<c:out value="${row.licenseDisk}"/>">

    <label for="kilometers">Kilometers</label>
    <input type="number" id="kilometers" name="kilometers" value="<c:out value="${row.kilometers}"/>">

    <label for="dateServiced">Date Serviced</label>
    <input type="date" id="dateServiced" name="dateServiced" value="<c:out value="${row.dateServiced}"/>">

    <label for="diagnosis">Diagnosis</label>
    <textarea id="diagnosis" name="diagnosis" value="<c:out value="${row.diagnosis}"/>"></textarea>

    <label for="cost">Cost</label>
    <input type="number" id="cost" name="cost" value="<c:out value="${row.cost}"/>">
